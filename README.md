...
The commercial / enterprise landing page for **[LoricaOS](https://github.com/LoricaOS)**,
served at **[loricaos.com](https://loricaos.com)** via GitHub Pages.

Counterpart to [`org-landing-page`](https://github.com/LoricaOS/org-landing-page)
(the open project at loricaos.org). Static HTML/CSS, no build step. Same dark
...
GitHub Actions. DNS for loricaos.com (apex A records to Pages + `www` CNAME) is set
separately; the `CNAME` file claims the domain. The contact CTA points at
`enterprise@loricaos.com` — wire that mailbox up when ready.
